<%-- 
    ...
    Created on : Apr 15, 2020, 10:34:03 PM
    Author     : Ro Mario
--%>
...
<html>
  <head>
   ...
   <body data-spy="scroll" data-target="#navbar1" data-offset="60">
    ...
    <div class="1stSection" id="regsuccess">
            ...
            <div class="row h-100">
                ...
                <div class="col-12"  >
                    ...
                    <div class="text-center m-0 vh-100 d-flex flex-column justify-content-center ">
                      <img class="img-fluid" src="img/regbanner.png" alt="Welcome to BINGO" id="regbanner">
                      
                      
                    
                        <div class="row">
                            <div class="col-lg-4 col-sm-6 mx-auto" id="regbanner2">
                                <div>
                                  <h1>You got a "Welcome Gift" of 200 Coins!</h1>
                                  <br>
                                  <br>
                                  <div>
                            ...
                            <div class="col-lg-4 col-sm-6 mx-auto">
                                <div>
                                  ...
                                  <div>
                                    <img class="img-fluid" src="img/present.png" alt="Welcome to BINGO" id="regbanner3">
                                </div>
                                </div>
                            </div>
                        </div>
